function [curve, tang, norm, bino]=curve_vdefortang_curvatureof1_function(s,s0)
...
% Tangent vector
tang(1,:)=F_T0-(1/2)*F_T2;
tang(2,:)=F_T1;
tang(3,:)=(1/(2*s0))*F_T2;

% Principal normal vector
norm(1,:)=F_N0-((1/2)*F_N2);
norm(2,:)=F_N1;
norm(3,:)=(1/(2*s0))*F_N2;
...
% Curve
curve(1,:)=F_curve0-((1/2)*F_curve2);
curve(2,:)=F_curve1;
curve(3,:)=(1/(2*s0))*F_curve2;
end